...
services = {
  "atentoapp001-service" = {
    task_family                  = "atentoapp001"
    container_name               = "atento-app001"
    ...
    desired_count                = 1
    env = {
      ALB_HOSTNAME    = "internal-4shark-atento-dev-app-lb-2106105836.us-east-1.elb.amazonaws.com"
    ...
    cloudwatch_log_group_name   = "/ecs/atento-app001"
  ...
  "worker_migration-service" = {
    ...
    cloudwatch_log_group_name   = "/ecs/atento-worker-migration"
    create_cloudwatch_log_group = true
    enable_cloudwatch_logging   = true
  }
  ...
  "worker-commission-service" = {
    ...
    cloudwatch_log_group_name   = "/ecs/atento-worker-commission"
    create_cloudwatch_log_group = true
    enable_cloudwatch_logging   = true
  }
  ...
  "worker_commission_tiger_shark-service" = {
    ...
    cloudwatch_log_group_name   = "/ecs/atento-worker-commission-white-shark"
    create_cloudwatch_log_group = true
    enable_cloudwatch_logging   = true
  }
  ...
  "worker_system-service" = {
    ...
    cloudwatch_log_group_name   = "/ecs/atento-worker-system"
    create_cloudwatch_log_group = true
    enable_cloudwatch_logging   = true
  }
  "worker_user-service" = {
  ...
  "worker_commission_tiger_shark-service" = {
    ...
    cloudwatch_log_group_name   = "/ecs/atento-worker-user"
    create_cloudwatch_log_group = false
    enable_cloudwatch_logging   = true
  }
